...
const WeatherApp=()=>{
    ...
    const formSubmit=async(e,cityName)=>{
        setIsLoading(true);
        e.preventDefault();
        try{
    ...
    return(<>
    <form onSubmit={(e)=>formSubmit(e,cityName)} style={{textAlign:"center",paddingTop:"5rem"}}>
    ...
    <Grid item xs={12} sm={6} md={3} >
       <div className="weather-card"  style={{backgroundColor:"#ffffff",textAlign:"center",margin:"1rem",width:"20rem",padding:"1rem",borderRadius:"8px"}}>
        ...
        <Grid item className="weather-card" xs={12} sm={6} md={3}>
        <div className="weather-card"  style={{backgroundColor:"#ffffff",textAlign:"center",margin:"1rem",width:"20rem",padding:"1rem",borderRadius:"8px"}}>
        <h4>Humidity</h4>
